...
const props = defineProps({
    ...
    stats: Object,     // Data statistik dari Controller
    temaChart: Object, // Data chart dari Controller
});
...
const doughnutData = {
    ...
    datasets: [{
        ...
        backgroundColor: ['#00139E', '#E2E8F0'],
        borderWidth: 0,
        cutout: '75%'
    }]
};

// 4. Data Topik (Category Grid)
const topicIcons = [
    ...
    <div class="space-y-8 max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section class="bg-[#000B58] rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between relative overflow-hidden shadow-xl">
            ...
            <div class="hidden md:block z-10">
                 <!-- <img src="/images/hero-dashboard.png" alt="Analisis Data" class="w-64 h-auto object-contain drop-shadow-2xl animate-float"> -->
            </div>
