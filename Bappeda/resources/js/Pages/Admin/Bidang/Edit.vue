        ...
        <div class="bg-white rounded-xl p-10 md:p-12 shadow-2xl shadow-primary/5 border border-gray-400 relative z-10">
            <div class="mb-12">
                <h1 class="text-3xl font-black text-primary leading-tight tracking-tight uppercase">
                    Edit <span class="text-secondary">Bidang Kerja</span>
                </h1>
                <p class="text-textsecondary font-medium mt-2 leading-relaxed">Perbarui nomenklatur bidang atau instansi pengelola data BAPPEDA.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="space-y-6">
                    <div class="space-y-2">
                        <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-textsecondary ml-2">
                            Nama Bidang / Instansi <span class="text-integritas">*</span>
                        </label>
                        <div class="relative">
                            <input 
                                ...
                                :class="{ 'border-integritas': form.errors.nama_bidang }"
                                required 
                            />
                        </div>
                        <p v-if="form.errors.nama_bidang" class="text-integritas text-[10px] font-black uppercase ml-2 tracking-tighter">{{ form.errors.nama_bidang }}</p>
                    </div>
                    ...
                    <div class="bg-profesional/10 border border-profesional/20 rounded-xl p-6 flex items-start gap-4 transition-all">
                        ...
                        <p class="text-[11px] text-profesional leading-relaxed font-bold uppercase tracking-tight">
                            Perubahan pada nama bidang otomatis memperbarui label kategori pada Inputer dan Indikator terasosiasi. Pastikan data sinkron dengan struktur organisasi terbaru.
                        </p>
                    </div>
                </div>
                ...
                <div class="pt-10 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-bgsoft">
                    <p class="text-[9px] font-black text-textsecondary uppercase tracking-widest text-center md:text-left opacity-50 leading-relaxed">
                        Perubahan akan dicatat <br class="hidden md:block"> dalam riwayat log sistem.
                    </p>
                    <div class="flex items-center gap-6 w-full md:w-auto">
                        <Link href="/admin/bidang" class="text-xs font-black uppercase tracking-widest text-textsecondary hover:text-integritas transition-colors">
                            Batal
                        </Link>
                        <button 
                            type="submit" 
