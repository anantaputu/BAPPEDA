        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
            <div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tight">
                    Manajemen <span class="text-[#00139E]">Tema</span>
                </h1>
                <p class="text-xs text-gray-400 font-bold uppercase tracking-[0.2em] mt-2 flex items-center gap-2">
                    ...
                    Total Klasifikasi: {{ tema.length }} Kategori
                </p>
            </div>
                ...
                <tbody class="text-sm font-bold text-gray-800">
                    <tr v-for="t in tema" :key="t.id_tema" 
                        ...
                        <td class="p-8">
                            <div class="flex items-center gap-4">
                                ...
                                <span class="font-black uppercase text-xs tracking-tight text-gray-900">{{ t.nama_tema }}</span>
                            </div>
                        </td>
                    ...
                    <tr v-if="tema.length === 0">
                        <td colspan="2" class="p-20 text-center text-gray-300 uppercase italic tracking-widest text-xs">
                            Belum ada data tema yang tersedia
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        >
            <div v-if="showModal" class="fixed inset-0 z-[100] flex items-center justify-center p-6">
                ...
                <div class="relative bg-white w-full max-w-md rounded-[2.5rem] p-10 shadow-2xl text-center transform transition-all border border-gray-100">
                    ...
                    <h3 class="text-2xl font-black text-[#000B58] mb-2">Hapus Tema?</h3>
                    <p class="text-[#A2B5CB] text-sm leading-relaxed mb-10 px-4">
                        Menghapus tema <span class="text-gray-900 font-bold">"{{ selectedTitle }}"</span> dapat mempengaruhi relasi data indikator di dalamnya. Pastikan Anda sudah mengecek keterkaitan data.
                    </p>
