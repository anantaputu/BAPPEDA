...
// Menggunakan useForm sesuai field di database: nama_katakunci
const form = useForm({
    nama_katakunci: ''
})

const submit = () => {
    // Diarahkan ke rute resource katakunci
    form.post('/admin/katakunci')
}
</script>

<template>
    <Head title="Tambah Kata Kunci Baru" />
        ...
        <div class="bg-white rounded-xl p-10 md:p-12 shadow-2xl shadow-primary/5 border border-gray-400 relative z-10">
            <div class="mb-12 text-center md:text-left">
                <h1 class="text-3xl font-black text-primary leading-tight tracking-tight uppercase">
                    Tambah <span class="text-secondary">Kata Kunci</span>
                </h1>
                <p class="text-textsecondary font-medium mt-2">Buat label atau tag baru untuk memudahkan pencarian dan kategorisasi data indikator.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input 
                                ...
                                type="text" 
                                placeholder="Contoh: Pertanian, Kemiskinan, Ekspor, BPS..." 
                        ...
                        <p v-if="form.errors.nama_katakunci" class="text-integritas text-[10px] font-black uppercase ml-2 tracking-tighter">{{ form.errors.nama_katakunci }}</p>
                    </div>
                    ...
                    <div class="bg-bgsoft border border-gray-200 rounded-xl p-6 flex items-start gap-4 transition-all hover:border-secondary/30">
                        <div class="p-2 bg-inovasi/10 rounded-lg text-inovasi">
                        ...
                        <p class="text-[11px] text-textsecondary leading-relaxed font-bold uppercase tracking-tight">
                            Kata kunci (tag) berfungsi sebagai label tambahan. User dapat memfilter banyak data sekaligus melalui label yang sama, meskipun berbeda tema atau urusan.
                        </p>
                    </div>
                </div>
                ...
                <div class="pt-10 flex items-center justify-end gap-6 border-t border-bgsoft">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Menyimpan...' : 'Simpan Kata Kunci' }}
                    </button>
                </div>
            </form>
        </div>
