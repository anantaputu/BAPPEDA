        ...
        <div class="bg-white rounded-[2.5rem] p-12 shadow-2xl shadow-gray-100 border border-gray-400">
            <div class="mb-10">
                <h1 class="text-4xl font-black text-gray-900 tracking-tight">
                    Edit <span class="text-[#00139E]">Frekuensi</span>
                </h1>
                <p class="text-gray-400 font-medium mt-2">Perbarui parameter rentang waktu update data. ID: #{{ props.frekuensi.id_frekuensi }}</p>
            </div>
