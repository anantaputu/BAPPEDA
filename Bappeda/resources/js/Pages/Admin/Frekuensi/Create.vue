...
<template>
    ...
    <div class="max-w-3xl mx-auto">
        <Link href="/admin/frekuensi" class="flex items-center gap-2 text-[#A2B5CB] hover:text-[#00139E] transition-colors mb-6 group">
            <svg class="w-5 h-5 transform group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
            <span class="font-bold uppercase tracking-widest text-[10px]">Kembali ke Daftar Frekuensi</span>
        </Link>

        <div class="bg-white rounded-[2.5rem] p-12 shadow-2xl shadow-gray-100 border border-gray-400">
            <div class="mb-10">
                <h1 class="text-4xl font-black text-gray-900 tracking-tight">
                    Tambah <span class="text-[#00139E]">Frekuensi</span>
                </h1>
                <p class="text-gray-400 font-medium mt-2">Tentukan parameter rentang waktu pembaruan data indikator.</p>
            </div>
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        <label class="text-[10px] font-black uppercase tracking-widest text-[#00139E] ml-4">
                            Nama Frekuensi Update <span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                            <input 
                                ...
                                :class="{ 'border-red-500': form.errors.nama_frekuensi }"
                                required 
                            />
                        </div>
                        <p v-if="form.errors.nama_frekuensi" class="text-red-500 text-xs ml-4 font-bold">{{ form.errors.nama_frekuensi }}</p>
                    </div>
                    ...
                    <div class="bg-blue-50/50 border border-blue-100 rounded-2xl p-6 flex items-start gap-4">
                        ...
                        <p class="text-[11px] text-blue-700 leading-relaxed font-medium">
                            Frekuensi ini digunakan untuk menginformasikan seberapa sering data pada suatu indikator harus diperbarui oleh OPD atau Bidang terkait dalam satu periode tahun anggaran.
                        </p>
                    </div>
                </div>

                <div class="pt-6 flex items-center justify-end gap-4 border-t border-gray-50">
                    <Link href="/admin/frekuensi" class="px-8 py-4 text-gray-400 font-bold hover:text-gray-600 transition-colors uppercase tracking-widest text-[10px]">
                        Batal
                    </Link>
                    <button 
                        type="submit" 
                    ...
                    >
                        ...
                        {{ form.processing ? 'Menyimpan...' : 'Simpan Frekuensi' }}
                    </button>
                </div>
            </form>
        </div>
