        ...
        <div class="bg-white rounded-[2.5rem] p-12 shadow-2xl shadow-gray-100 border border-gray-400">
            <div class="mb-10">
                <h1 class="text-4xl font-black text-gray-900 tracking-tight">
                    Tambah <span class="text-[#00139E]">Indikator Baru</span>
                </h1>
                <p class="text-gray-400 font-medium mt-2">Definisikan parameter indikator pembangunan daerah yang baru.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <input v-model="form.nama_indikator" type="text" placeholder="Masukkan nama indikator pembangunan..." 
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <input v-model="form.kata_kunci" type="text" placeholder="Ekonomi, Pertanian, Mataram..." 
                            class="w-full bg-gray-50 border-gray-200 rounded-2xl px-6 py-4 focus:ring-4 focus:ring-blue-100 focus:border-[#00139E] transition-all" />
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input v-model="form.satuan" type="text" placeholder="Jiwa / % / Km" 
                                class="w-full bg-gray-50 border-gray-200 rounded-2xl px-6 py-4 focus:ring-4 focus:ring-blue-100 focus:border-[#00139E] transition-all" />
                        </div>
                        <div class="space-y-2">
